...
import { ChefHat, Plus, Trash2, AlertTriangle, Info, ChevronDown, ChevronUp, Package, ArrowLeft, ArrowRight, Check } from 'lucide-react';
        ...
        {currentStep === 1 && (
          <div className="space-y-3 animate-fade-in">
            ...
            <div>
              ...
              />
              {errors.productId && <p className="text-xs text-danger mt-1 wrap-break-word">{errors.productId}</p>}
            </div>
            ...
            {isCreatingNewProduct && (
              <Card className="p-3 bg-teal-50 border-teal-200 space-y-3">
                <div className="flex items-center gap-2 text-teal-700">
                  <Package size={16} />
                  <span className="text-sm font-semibold wrap-break-wordword">Nuevo producto terminado</span>
                </div>
