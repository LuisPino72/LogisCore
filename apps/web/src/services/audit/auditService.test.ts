...
import { logAuditEvent, sanitizePayload, CRITICAL_EVENTS } from './auditService';

describe('auditService.ts — funciones puras', () => {
...
describe('auditService.ts — logAuditEvent (integración directa)', () => {
